...
import { findAddressByName, findNameByAddress, fromUnit, toFixed } from '../../lib/util';
...
function Farm(props) {
  ...
  useEffect(() => {
    ...
    list = list.sort((b, a) => {
      switch (sort) {
        ...
        case 3: 
           console.log('我只行了')
           console.log(Number(fromUnit(a.totalDeposits))-Number(fromUnit(b.totalDeposits)))
          return Number(fromUnit(a.totalDeposits))- Number(fromUnit(b.totalDeposits));
          break;
        case 4: 
  ...
  useEffect(async() => {
    // refreshTrigger==0 && setLoading(true)
    try {
      let pools = []
      let farm_first_list = []
